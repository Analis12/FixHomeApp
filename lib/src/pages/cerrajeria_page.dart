...
import 'package:fixhome/src/widgets/establishment_cerrajeria_card.dart';
import 'package:flutter/material.dart';

class EstablecimientoCerrajeria extends StatefulWidget {
  const EstablecimientoCerrajeria({Key? key}) : super(key: key);

  @override
  State<EstablecimientoCerrajeria> createState() =>
      _EstablecimientoCerrajeriaState();
}

class _EstablecimientoCerrajeriaState extends State<EstablecimientoCerrajeria> {
    ...
    return Material(
      child: Scaffold(
          appBar: AppBar(
            ...
            title: const Text('CERRAJERIA', style: headerStyle),
            actions: const [],
            centerTitle: true,
            elevation: 4,
            toolbarHeight: 80,
                ...
                : _listaEstablecimientos!.isEmpty
                    ...
                    : ListView(
                        children: _listaEstablecimientos!
                            .map((e) => EstablecimientoCerrajeriaCard(model: e))
                            .toList(),
                      ),
          ),
